...
var forcast = require('./utils/forecast');
...
app.get('/weather', function (req, res) {
  ...
  geocode(req.query.address, function (error) {
    ...
    forcast(latitude, longitude, function (error, forcastData) {
      if (error) {
        return res.send({
          error: error
        });
      ...
      res.send({
        'weather_temprature': forcastData.temp,
        'weather_icon': forcastData.weather_icon,
        'weather_description': forcastData.weather_descriptions,
        'perciptation': forcastData.perciptation,
        location: location,
        latitude: latitude,
        longitude: longitude
      });
